<form class="flex-1 max-w-lg my-3 mx-auto" method="POST" action="{{ route('media.store') }}">
    ...
    <div class="flex flex-wrap mb-2">
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <div class="relative">
                <select class="shadow-lg block appearance-none w-full bg-gray-800 border border-gray-200 text-gray-300 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:border-gray-500" id="grid-state">
